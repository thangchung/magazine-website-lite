...
namespace SharpLite.EntityFrameworkProvider
{
    public class DbContextManager
    {
        ...
        /// </summary>
        public static System.Data.Entity.DbContext Current
        {
            get
            {
        ...
        /// </summary>
        public static System.Data.Entity.DbContext CurrentFor(string key)
        {
            ...
            System.Data.Entity.DbContext context = null;
            lock (SyncLock)
            {
        ...
        {
            foreach (var ctx in Storage.GetAllDbContexts())
            {
        ...
        private static void AddConfiguration(string connectionStringName, ICollection<string> mappingAssemblies, bool recreateDatabaseIfExists = false, bool lazyLoadingEnabled = true)
        {
            ...
            lock (SyncLock)
            {
                DbContextBuilders.Add(connectionStringName,
                    new DbContextBuilder<System.Data.Entity.DbContext>(connectionStringName, mappingAssemblies, recreateDatabaseIfExists, lazyLoadingEnabled));
            }
        }

        /// <summary>
        /// An application-specific implementation of IDbContextStorage must be setup either thru
        /// <see cref="InitStorage" /> or one of the 
        /// <see>
        ///     <cref>Init</cref>
        /// </see>
        ///     overloads. 
        ...
        /// </summary>
        private static readonly Dictionary<string, IDbContextBuilder<System.Data.Entity.DbContext>> DbContextBuilders = new Dictionary<string, IDbContextBuilder<System.Data.Entity.DbContext>>();
