...
{
    public class QueryForLatestItems : IQueryForLatestItems
    {
        private readonly IRepository<Item> _itemRepository;

        public QueryForLatestItems(IRepository<Item> itemRepository)
        {
        ...
        public IEnumerable<ItemSummaryDto> GetLatestItems(int numOfItemOnHomePage)
        {
            ...
            return (from item in queryable
                    orderby item.ItemContent.NumOfView descending
